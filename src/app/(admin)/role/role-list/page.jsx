...
const RoleListPage = async () => {
  ...
  return <>
    <div className='d-flex w-100 py-4 justify-content-end'>
      <PageTItle title="ROLES LIST" />
      <Button className='outline-ff6c2fc d-flex justify-end' type='button' title='Create' onClick={()=> router.push('role-add')}>Create</Button>
    </div>
