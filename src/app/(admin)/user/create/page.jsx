...
const UserCreate = () => {
    ...
    console.log(userId)
    const [laodingUser, setLoadingUser] = useState(false);
    ...
    useEffect(() => {
        fetch('http://api-dev.aykutcandan.com/user/info/get/' + userId,
            ...
            .then((res) => {
                ...
                fetch('http://api-dev.aykutcandan.com/user/detail/get/' + userId,
                    {
                        method: "GET",
                        headers: {
                            'Authorization': `Bearer ${decodeURIComponent(session)}`
    ...
    return  <>
        <div className="d-flex flex-column jsutify-content-start">
            <Container>
